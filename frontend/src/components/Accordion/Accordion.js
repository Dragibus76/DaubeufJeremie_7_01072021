    ...
    <div className={`accordion ${active && "active"}`}>
      ...
      <div className="accordion__content">
        {allComments.map((element) => {
          const messageCommentLikeByCurrentUser =
            element?.CommentsLikes?.filter(
          ...
          return (
            <div className="accordion-comment-card" key={element.id}>
              <div>Publiée {moment(element.createdAt, "MMMM Do YYYY, h:mm:ss a").fromNow()}</div>
              ...
              <div className="container_comments">
                ...
                <div className="accordion-avatar-name">
                  ...
                  <div className="accordion-comment-username">
                    {firstnameLastname}
                  </div>
                </div>
                <div className="accordion-comment-content">
                  {element.content}
                </div>
              </div>
